...
<body id="body-pd">
    <header class="header" id="header">
        ...
        <p style="font-size: 30px; margin-top: 12px;">K1J Ltd | Products</p>
            ...
            <div>
              <a href='index.php' class='nav_logo'> <i class='bx bx-layer nav_logo-icon'></i> <span class='nav_logo-name'>K1J Ltd</span> </a>
                <div class='nav_list'>
                  ...
                  <a href='products.php' class='nav_link active'> <i class='bx bx-store-alt nav_icon'></i> <span class='nav_name'>Products</span> </a>
          ...
          <table id="dtBasicExample" class="table table-striped table-bordered table-sm table-wrapper-scroll-y my-custom-scrollbar" cellspacing="0" width="100%">
            <thead>
              <tr>
                ...
                <th class="th-sm">Number of Sales
                </th>
                <th class="th-sm">Number of Interactions
                </th>
            ...
            <tr>
               ...
               <td><?php echo htmlspecialchars($row['numOfSales']); ?></td>
               <td><?php echo htmlspecialchars($row['numOfInteractions']); ?></td>
