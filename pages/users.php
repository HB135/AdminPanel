...
<body id="body-pd">
    <header class="header" id="header">
        ...
        <p style="font-size: 30px; margin-top: 12px;">K1J Ltd | Customers</p>
            ...
            <div>
              <a href='index.php' class='nav_logo'> <i class='bx bx-layer nav_logo-icon'></i> <span class='nav_logo-name'>K1J Ltd</span> </a>
                <div class='nav_list'>
                  ...
                  <a href='users.php' class='nav_link active'> <i class='bx bx-list-ul nav_icon'></i> <span class='nav_name'>Users | Customers</span> </a>
        ...
        <div class="row">
          ...
          <table id="dtBasicExample" class="table table-striped table-bordered table-sm table-wrapper-scroll-y my-custom-scrollbar" cellspacing="0" width="100%">
            ...
            <tr>
               ...
               <td><?php echo htmlspecialchars($row['addressLine1']); ?>
               <?php echo ','; ?>
               <?php echo htmlspecialchars($row['addressLine2']); ?>
               <?php echo ','; ?>
               <?php echo htmlspecialchars($row['city']); ?>
               <?php echo ','; ?>
               <?php echo htmlspecialchars($row['region']); ?>
               <?php echo ','; ?>
               <?php echo htmlspecialchars($row['postcode']); ?></td>
            </tr>
            <?php endwhile; ?>
           </tbody>
          </table>
          ...
          <a href='emailer.php' type="button" class="btn btn-success">Send email</a>
        </div>
      </div>
